...
# Using the {{site.data.keyword.cloud_notm}} CLI for {{site.data.keyword.databases-for-mongodb}}

Use the {{site.data.keyword.cloud_notm}} CLI and the cloud databases plug-in to access and manage {{site.data.keyword.databases-for-mongodb_full}}.
...
For more information on how IAM affects {{site.data.keyword.databases-for-mongodb}}, see the [IAM reference page](./reference-access-management.html)