...
{{site.data.keyword.databases-for-mongodb_full}} is integrated with [{{site.data.keyword.la_full_notm}}](/docs/services/Log-Analysis-with-LogDNA?topic=LogDNA-about), so you can view database logs.
