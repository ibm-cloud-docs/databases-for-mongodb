...
You can use the [monitoring integration](/docs/services/databases-for-mongodb?topic=cloud-databases-monitoring) to estimate typical resource usage, and scale your deployment accordingly.
