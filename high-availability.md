...
{{site.data.keyword.databases-for-mongodb}} does not auto-scale. Deployment owners can [monitor](/docs/services/databases-for-mongodb?topic=databases-for-mongodb-monitoring) the state of the deployment, estimate typical resource usage, and scale the deployment accordingly.
