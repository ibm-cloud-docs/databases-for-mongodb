...
keywords: databases, mongodb, Enterprise Edition, sharding, horizontal scaling
...
![Sharding architecture](images/Mongo_sharding_plan.svg){: caption="MongoDB sharding architecture" caption-side="bottom"}
